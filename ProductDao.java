...
public class ProductDao {
    ...
    {
        String query = "update product set name='"+product.getName()+"',category='"+product.getCategory()+"',price='"+product.getPrice()+"' where name='"+product.getName()+"'";
    ...
    public static ArrayList<Product>getAllRecordsByCategory(String category)            
    {
        ...
        try{
            ...
            //will return all the categories
            while(rs.next())
            {
                Product product = new Product();
                product.setName(rs.getString("name"));
     ...
     public static ArrayList<Product>filterProductByname(String name,String category)            
    {
        ...
        try{
            ...
            //on the basis of category if we search anything
            while(rs.next())
            {
                Product product = new Product();
                product.setName(rs.getString("name"));
